const Footer = () => {
  return (
    <>
      <footer className="w-[90%] mx-auto flex flex-col items-center border-t-2 border-[#101314] dark:border-neutral-200 bg-white dark:bg-[#101314] text-center text-surface dark:text-white">
